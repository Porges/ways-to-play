...
<Footnote>
<p><span className="footnote-marker">§</span> {cite(LegendsOfHonolulu, undefined, true)} indicates that the site was the “Spreckels Building”, which was on Fort Street between Merchant St and Queen St.</p>
</Footnote>
<Footnote>
<p><span className="footnote-marker">‖</span> Specifically, {cite(LegendsOfHonolulu, undefined, true)} states that they were near Kekūanāoʻa’s house, which was on the corner of King and Richards Streets.</p>
</Footnote>
