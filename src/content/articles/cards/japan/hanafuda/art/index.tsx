...
const Hanafuda: React.FC = () => {
    ...
    <Section title="Origins">
        ...
        <p><Noun lang="ja-Latn">Kihei</Noun> had recently moved to <Noun lang="ja-Latn">Tōkyō</Noun> and was convinced through his reading of legal texts that <Noun lang="ja-Latn">Hanafuda</Noun> were not actually prohibited. However, he found that the local landlords refused to let to him, believing his business illegal, and he was unable to convince newspapers to print his advertisements. So, in order to prove himself correct, he officially petitioned the <Noun lang="ja-Latn">Tōkyō</Noun> police to ban the sale of <Noun lang="ja-Latn">Hanafuda</Noun>. His petition was declined, the court stating that the sale of <Noun lang="ja-Latn">Hanafuda</Noun> was legal, and later that month he opened his first shop in <Noun lang="ja-Latn">Nihonbashi</Noun> (<Noun lang="ja-Latn">Ōsaka</Noun>), named <Noun lang="ja-Latn">Kamigataya</Noun> (<span lang="ja">上方屋</span>).<Cite r={EbashiHanafuda} page={[[189, 192]]} /></p>
        <Footnote>
    ...
    <Section title="Art of the Cards">
      ...
      <Footnote>
        <p>In Kyoto from the 11th to 13th centuries, the average peak of the cherry blossom season was April 17th.<Cite r={FourSeasons} page={484} pageType="l." /></p>
      </Footnote>
        <p>While nominally the cards start in ‘January’, at the time the deck was created Japan’s calendar was based upon the lunisolar Chinese calendar, which started in what is now February. This explains why ‘March’ is the month of the cherry blossom when — according to the current calendar — it should be April, and why ‘August’ shows the full moon when the full moon festival (<span lang="ja">月見</span> <Pronounce pronouncer="skent" word="tsukimi" lang="ja-Latn" file={pronTsukimi}/>) actually falls in September–October.</p>
    ...
    <Section title={<><span lang="ja">5月</span> — iris (<span lang="ja">菖蒲</span> <Pronounce pronouncer="akitomo" word="ayame" lang="ja-Latn" file={pronAyame}/>)</>}>
        ...
        <p>The bridge shown on the species card is a reference to the ‘eight bridges’ (<span lang="ja">八橋</span> <Pronounce pronouncer="poyotan" word="yatsuhashi" lang="ja-Latn" file={pronYatsuhashi}/>) featured in an episode of the <cite>Tales of Ise</cite> (<cite lang="ja">伊勢物語</cite> <span lang="ja-Latn">Ise Monogatari</span>), in which the unnamed protagonist of the story comes across a braided river that is crossed by eight overlapping planks forming a zig-zag bridge. Challenged to compose a poem on the subject “a traveller’s sentiments”, he recites the following:</p>
        <section>
            <ArticleImage
                position="left"
    ...
    <Section title={<><span lang="ja">11月</span> — willow (<span lang="ja">柳</span> <Pronounce pronouncer="akitomo" word="yanagi" lang="ja-Latn" file={pronYanagi}/>)</>}>
        ...
        <p>The lightning card is the red-coloured junk card, which is also called the ogre card (<span lang="ja">鬼札</span> <Pronounce pronouncer="strawberrybrown" word="onifuda" lang="ja-Latn" file={pronOnifuda}/>). The drums, which are visible in some patterns, are an attribute of the thunder god <Noun lang="ja-Latn">Raijin</Noun> (<span lang="ja">雷神</span>). In many games this card has special abilities such as being able to match any other card.</p>
    </Section>
