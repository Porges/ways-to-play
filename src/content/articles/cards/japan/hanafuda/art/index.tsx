...
const Hanafuda: React.FC = () => {
  return (<>
    <Section title="Origins">
      ...
      <p><Noun lang="ja-Latn">Hanafuda</Noun> seem to originate in a combination of the themes of <span lang="ja-Latn">kai-awase</span> — matching sets, poetry, conventionalized art — with the ideas introduced by the Portuguese playing cards — a regular structure of <i>suits</i> divided into different <i>ranks</i>. Early 18th century ancestors of <Noun lang="ja-Latn">Hanafuda</Noun> (such as the <span lang="ja-Latn">hana-awase</span> deck below) show a very regular configuration of cards for each flower, which evolved during the 18th century into the unusual configuration of the <Noun lang="ja-Latn">Hanafuda</Noun> deck.</p>
      <ArticleImage
        noborder
        position="wide"
        src={img1704Deck}
