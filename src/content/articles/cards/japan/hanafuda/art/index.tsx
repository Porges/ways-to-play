...
const Hanafuda: React.FC = () => {
  return (<>
    <Section title="Origins">
      ...
      <p>In 966, Emperor Murakami held a <span lang="ja-Latn">mono-awase</span> competition on the 15th of the 8th month (the most important full moon of the year). The <span lang="ja-Latn">suhama</span> of each team is recorded in the <a href="https://en.wikipedia.org/wiki/Eiga_Monogatari"><cite lang="ja-Latn">Eiga Monogatari</cite></a>:</p>
      <blockquote>
      ...
      <p>A competition could run all day; another famous competition held by Emperor Murakami six years earlier, on the 30th day of the 3rd month of 960, which ran from 4 p.m. until dawn, when the winning team exited while singing and dancing. A courtier’s diary recorded the elaborate preparations made at the palace:<Cite r={MuseInCompetition} page={[[214, 217]]} /></p>
      <blockquote>
      ...
      <Section title={<>A little about <span lang="ja-Latn">Uta-awase</span></>}>
        ...
        <p>The poetry competition was highly ritualized, where the result of a contest was not only about who could compose the better poem. Overall, authors of a higher rank were more likely to win. In some cases, the winner of a round was decided by convention, and furthermore, some poems could not lose! The first poem by the “left” team, a poem complimenting the host, or a poem by the Emperor himself would <em>at worst</em> result in a draw.<Cite r={UtaawaseJudgments} page={102} /> At one competition <a href="https://en.wikipedia.org/wiki/Emperor_Uda">Emperor <Noun lang="ja-Latn">Uda</Noun></a> (<span lang="ja">宇多天皇</span>) awarded his own poem a draw, stating “how can an imperial poem lose?”<Cite r={BrocadeByNight} page={244} /></p>
        <p>Later, during what <Noun lang="ja-Latn">Ito Setsuko</Noun> terms the “silver age” of <span lang="ja-Latn">uta-awase</span>, the work of the poet became more important, and poetry competitions were held without the extravagant <span lang="ja-Latn">suhama</span> — in 1083 a planned grand competition was cancelled as it was thought to be inappropriate given the unrest at the time. Smaller and more austere competitions were held with poetry as their focus. This doesn’t mean that the proceedings were any less elaborate; the largest competition involved nine poets competing over 1500 rounds.<Cite r={MuseInCompetition} page={207} /></p>
        <p></p>
      </Section>
      <ArticleImage
        src={imgKaiAwase}
