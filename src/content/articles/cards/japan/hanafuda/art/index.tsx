  ...
  return (<>
    <Section title="Origins">
      ...
      <Section title={<><span lang="ja-Latn">Kai-awase</span> to <span lang="ja-Latn">Kai-ōi</span></>}>
        ...
        <p>In one form of the game, the left-hand sides of the shells — also termed the “male” or ‘ground’ (<span lang="ja">地</span>) shells — were arranged face-down on the ground. The right-hand sides — the “female” or ‘coming out’ (<span lang="ja">出</span>) shells — were then drawn from their <span lang="ja-Latn">kai-oke</span> (<span lang="ja">貝桶</span>, ‘shell bucket’) one-by-one and the players would attempt to match them with those on the floor. Whoever was the first to point out a (successful) match would capture both halves of the shell, and the winner was the player who collected the most shells.</p>
      ...
      <Section title="Banning &amp; Legalization">
        ...
        <blockquote>What are the qualifications of a <span lang="ja-Latn">shinshi</span>? Gambling with <Noun lang="ja-Latn">Hanafuda</Noun>, keeping a mistress, being in debt, and being busy.</blockquote>
        <p>Another commentator ironically remarked that “if you can’t play skillfully with 48 flower cards, you can’t be a <span lang="ja-Latn">sōninkan</span> [<span lang="ja">奏任官</span>, a type of official appointed by the prime minister]”.</p>
        ...
        <p>However, despite his protestations that “I do not care for playing at cards, but I know the methods”, he goes on to give a detailed account of the gameplay — far more than a casual observer would know!</p>
      </Section>
