...
import { Noun, ArticleImage, ArticleContentProps, Footnote, SourceInfo, Section } from 'ui';
...
const Hanafuda: React.FC<ArticleContentProps> = ({cite, pronounce}) => {
    ...
    <Section title={<><span lang="ja">1月</span> — pine (<span lang="ja">松</span> {pronounce("_ai_", "matsu", "ja-Latn", pronMatsu)})</>}>
        <ArticleImage
            src={[
    ...
    <Section title={<><span lang="ja">2月</span> — plum (<span lang="ja">梅</span> {pronounce("akitomo", "ume", "ja-Latn", pronUme)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda2_4, ""],
    ...
    <Section title={<><span lang="ja">3月</span> — cherry (<span lang="ja">桜</span> {pronounce("strawberrybrown", "sakura", "ja-Latn", pronSakura)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda3_4, ""],
    ...
    <Section title={<><span lang="ja">4月</span> — wisteria (<span lang="ja">藤</span> {pronounce("kaoring", "fuji", "ja-Latn", pronFuji)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda4_4, ""],
    ...
    <Section title={<><span lang="ja">5月</span> — iris (<span lang="ja">菖蒲</span> {pronounce("akitomo", "ayame", "ja-Latn", pronAyame)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda5_4, ""],
    ...
    <Section title={<><span lang="ja">6月</span> — peony (<span lang="ja">牡丹</span> {pronounce("ryomasakamoto", "botan", "ja-Latn", pronBotan)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda6_4, ""],
    ...
    <Section title={<><span lang="ja">7月</span> — bush clover (<span lang="ja">萩</span> {pronounce("strawberrybrown", "hagi", "ja-Latn", pronHagi)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda7_4, ""],
    ...
    <Section title={<><span lang="ja">8月</span> — miscanthus/silvergrass (<span lang="ja">芒/薄</span> {pronounce("kaoring", "susuki", "ja-Latn", pronSusuki)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda8_4, ""],
    ...
    <Section title={<><span lang="ja">9月</span> — chrysanthemum (<span lang="ja">菊</span> {pronounce("akitomo", "kiku", "ja-Latn", pronKiku)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda9_4, ""],
    ...
    <Section title={<><span lang="ja">10月</span> — autumn leaves/maple (<span lang="ja">紅葉</span> <span lang="ja-Latn">momiji</span>/{pronounce("El55", "kōyō", "ja-Latn", pronKoyo)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda10_4, ""],
    ...
    <Section title={<><span lang="ja">11月</span> — willow (<span lang="ja">柳</span> {pronounce("akitomo", "yanagi", "ja-Latn", pronYanagi)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda11_4, ""],
    ...
    <Section title={<><span lang="ja">12月</span> — paulownia (<span lang="ja">桐</span> {pronounce("kaoring", "kiri", "ja-Latn", pronKiri)})</>}>
        <ArticleImage
            source={svgSourceInfo}
            src={[
                [imgHanafuda12_4, ""],
