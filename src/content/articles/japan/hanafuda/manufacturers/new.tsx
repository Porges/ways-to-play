...
const Manufacturers: React.FC<ArticleContentProps> = ({cite}) => {
    return (
        ...
        <section id="blank-project">
          <h3><a href="https://blankproject.kr/">Blank’s Art Project</a></h3>
        ...
        <section id="nishiki-fuda">
          <h3><a href="https://www.etsy.com/shop/nishikie" lang="ja-Latn" className="proper-noun">NISHIKI <span lang="ja">錦</span></a></h3>
        ...
        <section id="junior">
          <h3><a href="https://www.junior.cards/">Junior Cards</a></h3>
