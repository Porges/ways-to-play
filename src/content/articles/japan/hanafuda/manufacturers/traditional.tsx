...
const Manufacturers: React.FC<ArticleContentProps> = ({cite}) => {
    return (
        ...
        <section id="iwata-honten">
          <h3><Noun lang="ja-Latn">Iwata Honten</Noun> (<span lang="ja">岩田本手</span>)</h3>
        ...
        <section id="ryutendo">
          ...
          <p>Existed in <Noun lang="ja-Latn">Kyōto</Noun> in 1948;{cite(Yamaguchi, [102])} mark was a circled <span lang="ja">龍</span>.</p>
        </section>
        <section id="inoue">
