    ...
    <Row>
      ...
      <Col lg="6">
        <article>
          ...
          <p>I was somewhat inspired by (but make no claim to approaching) W. G. Sebald’s <cite>Rings of Saturn</cite>; games are a foothold for climbing inside other cultures and other times.</p>
          ...
          <p>The font used for ISBN numbers is <a href="https://tsukurimashou.osdn.jp/ocr.php.en">OCR-B produced by Matthew Skala</a>, and released under GPL version 3 (with an exception for using the font in documents).</p>
          <h2 id="colophon">Colophon</h2>
          <p>The site is generated with React, using react-snap to output HTML pages.</p>
          <p>The fonts are <a href="https://rsms.me/inter/">Inter by Rasmus Andersson</a> (body text), <a href="https://github.com/bBoxType/FiraSans">Fira Sans</a> (body italics), &amp; <a href="http://vollkorn-typeface.com/">Vollkorn by Friedrich Althausen</a> (headings).</p>
        </article>
      </Col>
      <Col />
    </Row>
