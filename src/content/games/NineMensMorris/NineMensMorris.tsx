...
@PlayedAtThePub, p. 150].
  */}
  ...
  <Section title="History">
    ...
    <p>The game dates from at least the late Roman Empire or Byzantine period, and at the moment we do not have solid evidence for an earlier date.<Cite r="GamesGreekAndRoman" page={3} /><Footnote><Cite r="RamatHanadiv" page={227} inline /> describes a board found in a Byzantine villa in <span lang="he">חורבת עקב</span> (<Noun lang="he-Latn">Ḥorvat ʿAqav</Noun>), dated 400–600&nbsp;CE, while a cache of gaming boards found in a Roman fort at <Noun lang="ar-Latn">Abu Sha’ar</Noun> that was abandoned in the late 4th century contained no mills boards.<Cite r="RomanGameBoards" /></Footnote> Earlier dates have often been proposed based upon the existence of boards carved on ancient monuments such as the Ramesseum<Cite r="AncientEgyptiansAtPlay" page={144} /> and the Mortuary Temple of Seti I at Qurna,<Cite r="AncientCeylon" page={644} /> but these are not able to be dated definitively—the monument only provides an <em>earliest possible</em> date.</p>
    <p>The game became popular throughout Europe: a double-sided game board with a Nine Men’s Morris layout on one side was found as part of the  <a href="https://en.wikipedia.org/wiki/Gokstad_ship">Gokstad Viking ship burial</a> (<abbr title="circa">c.</abbr> 900) which was discovered in Norway.<Cite r="TheVikingShipFromGokstad" page={[44, 99]} /> Another boat burial (the “<Noun lang="sv">Årby</Noun> boat”) from around the same time also included a Morris game.<Cite r="BoardGamesInBoatBurials" page={441} /></p>
    ...
    <p>By examining depictions of the game in artwork, we can understand the attitude towards the game at the time the image was produced. In the manuscript image below (<abbr title="circa">c.</abbr> 1340), nobles of opposite sex face each other across a game board. Evidently the game was considered worthy of being played by the nobility, and suitable for men and women to play together:</p>
    <ArticleImage
      size="wide"
    ...
    <p>However, in this woodcut by Hans Weiditz from <Cite r="Trostspiegel" page={24} inline/> — a German version of Petrarch’s <cite>De remediis utriusque fortunae</cite> published some 200 years later in 1572 — we can see Chess being played by nobles and Backgammon by ordinary men, but Nine Men’s Morris is being played by monkeys:</p>
    <ArticleImage
      noborder
      size="wide"
