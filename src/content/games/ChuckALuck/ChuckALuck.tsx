...
const Content: React.FC = () => <>
  ...
  <Section title="Fairground variants">
    ...
    <Section title="Jumbo Dice Wheel (Big Six)">
      <p>The standard version of this nowadays (at least in the United States) is a wheel-of-fortune with money printed on it, but in its earliest form the wheel had dice drawn in each sector. As with Spindle Chuck-A-Luck, the distribution of the dice rolls has been manipulated to provide the operator extra income. The house edge on the wheel on the right below, with 48 sectors, is 14.583%. The edge on the wheel at left, with 54 sectors, is 12.963%.<Footnote><p>Or at least, it is intended to be. The wheel represented here seems to have an error where one 5 has been switched with a 3, so the edge on those two numbers is different.</p><p>Scarne<Cite r="ScarneGambling" page={[[501, 503]]} /> miscalculates the house edge on this wheel as 22.22%, as it seems has was working from a different version than in the photo.</p></Footnote></p>
