...
const Teeko: React.FC = () => <>
    ...
    <Section title="History">
        ...
        <p>The game was first published by Scarne in 1955 in <Cite r="Teeko" inline />. This is possibly the only game rulebook ever produced that has had <a href="https://www.quinapalus.com/musical.html">an opera written about it</a>!</p>
        <p>Scarne thought so much of the game that he named his son (John Teeko Scarne) after the game.<Cite r="AWorldOfGames"/> His (future) wife Steffi Storm is also described in the book as a “top-ranking Teeko player”, although she would later state that “if I win, it’s by dumb luck.”<Cite r="AWorldOfGames" /></p>
    </Section>
