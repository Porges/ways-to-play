...
The same game was reported under the name <span lang="pis">kura</span> in the Solomon Islands in the 1970s,[@EthnographicPsychology 271][^fn3] and it is still played there to this day.[@IllegalCardGamesToBeBanned]

[^fn3]: The word also seems to apply to gambling in general.

In Papua New Guinea it has been called <span lang="tpi">kawu</span> — clearly derived from the Japanese name.[@ThreeMoreNewGuineanCardGames 54][^fn4] Further versions of this game — of which there are many — are called <span lang="tpi">laki</span> (‘lucky’),[@ThreeNativeCardGames 50] and these variants are described below.
...
In the past, some combinations of hands totalling 9 (<span lang="ja-Latn">kabu</span>) were named. In the erotic book <cite>Amorous Plum Hedge</cite> (<cite lang="ja">好色梅花垣</cite>, date unknown to me), the following names were given. The meaning of most of the names is obscure.[@EbashiKabuCarta] I have attempted some guesses below.

* <Cards>153</Cards>: <span lang="ja">御かぶ</span> <span lang="ja-Latn">o&shy;kabu</span> ‘royal nine’.
* <Cards>234</Cards>: <span lang="ja">のぼりがぶ</span> <span lang="ja-Latn">nobori&shy;kabu</span> ‘ascending nine’[^fn6] ,  this is the only obvious name.
* <Cards>333</Cards>: <span lang="ja">今みやがぶ</span> <span lang="ja-Latn">imamiyagabu</span>, perhaps “<span lang="ja-Latn" class="noun">Imamiya</span> shrine nine”. A wild guess, but the <Cards>3</Cards> from the Kabufuda deck could look like skewers, resembling the skewered <span lang="ja-Latn">aburimochi</span> (grilled sticky rice) which can be found at the shrine.
* <Cards>559</Cards>: <span lang="ja">でつくがぶ</span> <span lang="ja-Latn">detsukugabu</span> ???
* <Cards>757</Cards>: <span lang="ja">二条蔵人あいごがぶ</span> <span lang="ja-Latn">nijō kurōdo ai go gabu</span> ‘two-card imperial-archivist meeting five nine’ (?) — the position of head of the imperial archivists (<span lang="ja">蔵人頭</span> <span lang="ja-Latn">kurōdo</span> or <span lang="ja-Latn">kurando no tō</span>, usually translated ‘head chamberlain’) was held by two people, who were personally selected by the Emperor.
* <Cards>883</Cards>: <span lang="ja">雷公がぶ</span> <span lang="ja-Latn">raikō gabu</span> ‘thunder nine’ — using the name of a [Chinese god of thunder](https://en.wikipedia.org/wiki/Leigong).

[^fn6]: i.e. <span lang="ja">上り</span> — not, as Japanese Wikipedia has, [<span lang="ja">幟</span>](https://en.wikipedia.org/wiki/Nobori).

Similarly, in the <span lang="ja-Latn">bunraku/kabuki</span> play <cite>Ōtō-no-Miya and the Armor of the Rising Sun</cite> (<cite lang="ja">大塔宮曦鎧</cite>), staged for the first time in 1723, other names are given for some zero-scoring hands:[@EdoKaruta7]
...
> Eeh! Meeting the eyes of a worthless <span lang="ja-Latn">yakuza</span>!

This term was adopted by gamblers as a nickname and eventually became the standard term for a Japanese gangster.

As to _why_ this particular hand was chosen, there are several options. Note that it is not the only hand that sums to zero; there are 22 such hands.  However, it is the only hand containing an <Cards>8</Cards> and a <Cards>9</Cards> that results in a zero score; thus, seeing as the name of the game <span lang="ja-Latn">Oicho Kabu</span> means “8, 9…” it is naturally followed by “3”.

### <span id="kabu">Kabu</span>

This is a simplified variant of <span lang="ja-Latn" class="noun">Oicho-Kabu</span> by [Sid Sackson](articles/people/sid-sackson.md), for 2–6 players, as described in @CardGamesAroundTheWorld [12].
