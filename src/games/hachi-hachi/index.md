...
first set is based upon having sets of cards in the same month, and the second
set is based upon having a large number of 1-point (<span
...
is only one way this hand can be formed, giving it a
1-in-73&#x202f;629&#x202f;072 chance of occurring! Even ordinary <span
lang="ja-Latn">shi&shy;sō</span> has a mere 1-in-139&#x202f;449 chance of being
dealt, and when this happens it is a common house rule that the round is
instantly won by the player who receives such a hand; some sources suggest that
the deck should then be burned.
...
The overall number of possible hands with combinations from each set of <span
lang="ja-Latn">te&shy;yaku</span> are as follows. Each cell indicates the number
of possible hands which contain both the given ‘set’ and <span lang="ja-Latn">‘kasu’
yaku</span>, as well as the overall probability (many entries round to zero).
...
The number of <span lang="ja-Latn">deki&shy;yaku</span> is much smaller than the
number of <span lang="ja-Latn">te&shy;yaku</span>, but the number of them has grown
