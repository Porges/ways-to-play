...
const { ifSet, asAttr, renderArticleList } = require('../../helpers');
...
exports.render = async function (data) {
    ...
    if (data.tags.includes('article')) {
        ...
        const parent = this.eleventyNavigation(data.collections.all, data.eleventyNavigation.parent);
        parent.sort((x, y) => x.title.localeCompare(y.title, 'en'));
