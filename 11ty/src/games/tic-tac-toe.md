---
title: Tic-Tac-Toe
mainImage: 'tic-tac-toe/5072574617_9afa5ee9ae_o.jpg'
---
...
{% image
  src="tic-tac-toe/Alfonso_AdT.jpg",
  alt="",
  license="cc0" %}
...
{% image
  size="wide",
  src="tic-tac-toe/large_BAB_S20_0002.jpg;tic-tac-toe/large_BAB_S20_0003.jpg",
...
Swedish equivalent of <Pronounce file={pronTrippTrapp} lang="sv"
pronouncer="tigris" word="tripp, trapp, trull" /> (see more below). The three
houses in [Kalmar](https://en.wikipedia.org/wiki/Kalmar) in the
following image are nicknamed the “<span lang="sv">tripp trapp trull</span>
houses”:

{% image 
  src="tic-tac-toe/Tripp_trapp_trull_kalmar.jpg",
...
{% image
  position="right",
  src='tic-tac-toe/tick-tack-toe.png'
...
(‘butter cheese and eggs’); and the Swedish ‘<Pronounce file={pronTrippTrapp}
lang="sv" word="tripp, trapp, trull" pronouncer="tigris" />’.[@Fiske p. 137]
...
{% image
  size="wide"
  src="tic-tac-toe/5072574617_9afa5ee9ae_o.jpg",
...
{% image
  size="wide"
  src='tic-tac-toe/8576897675_c7c5785b4a_o.jpg'
...
{%image
  noborder=true,
  src="tic-tac-toe/Freeland_Input.jpg;tic-tac-toe/Freeland_Cylinder.jpg",
  alt=";",
  license="cc0" %}
...
{% image
  src="tic-tac-toe/bird_brain.jpg",
  alt="",
...
Some general references for the game are @OxfordBG [112–113], @Bell [p. 91], and @Murray2 [§3.2.1, p. 40].
